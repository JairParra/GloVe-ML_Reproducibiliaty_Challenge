...
def main():
    ...
    parser = argparse.ArgumentParser() # config arguments
    parser.add_argument('--vocab_file', default='vocab.txt', type=str) # arg for vocabulary file 
    parser.add_argument('--vectors_file', default='vectors.txt', type=str) # arg for vectors file  
